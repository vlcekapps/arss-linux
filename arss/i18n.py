...
MESSAGES: dict[str, dict[str, str]] = {
    "cs": {
        ...
        "feed_error_invalid_url": "Adresa feedu není platná.",
        "feed_error_network": "Feed se nepodařilo stáhnout. Zkontrolujte připojení k internetu a zkuste to znovu.",
        "feed_error_http": "Server vrátil HTTP chybu {status}.",
        "feed_error_redirect": "Server vrátil neplatné přesměrování nebo jich bylo příliš mnoho.",
        "feed_error_too_large": "Feed překročil povolenou velikost {maximum} bajtů.",
        "feed_error_invalid_xml": "Feed není platný XML dokument.",
        "feed_error_unsupported_format": "Dokument není podporovaný RSS 2.0 ani Atom 1.0 feed.",
        "feed_error_unknown": "Došlo k neznámé chybě.",
        "save_error": "Změny se nepodařilo bezpečně uložit. Původní data zůstala zachována.",
        "store_unavailable": "Uložený seznam nelze bezpečně přečíst. Změny jsou vypnuté, aby se soubor nepřepsal.",
        ...
        "directory_error": "Katalog se nepodařilo prohledat. {detail}",
        "directory_error_network": "Katalog se nepodařilo stáhnout. Zkontrolujte připojení k internetu a zkuste to znovu.",
        "directory_error_http": "Server katalogu vrátil HTTP chybu {status}.",
        "directory_error_redirect": "Server katalogu vrátil neplatné nebo nezabezpečené přesměrování.",
        "directory_error_too_large": "Odpověď katalogu překročila povolenou velikost {maximum} bajtů.",
        "directory_error_invalid_response": "Katalog vrátil neplatnou odpověď.",
        "directory_error_unknown": "Při práci s katalogem došlo k neznámé chybě.",
        ...
        "opml_import_error": "OPML soubor se nepodařilo importovat. {detail}",
        "opml_export_error": "OPML soubor se nepodařilo uložit. {detail}",
        "opml_error_invalid_document": "Soubor není platný a bezpečný dokument OPML.",
        "opml_error_file_access": "K vybranému souboru se nepodařilo přistoupit.",
        ...
        "guide_catalog_error": "Seznam stanic se nepodařilo načíst. Zkontrolujte připojení k internetu a zkuste to znovu.",
        ...
        "playback_error_detail": "Epizodu se nepodařilo přehrát.",
        "speed_change_error": "Rychlost přehrávání se nepodařilo změnit.",
        "audio_session_denied": "Zvuk právě používá jiná aplikace.",
        "play": "Přehrát",
        "pause": "Pozastavit",
        ...
        "language_change_error": "Jazyk aplikace se nepodařilo změnit.",
        ...
        "background_checks_error": "Nastavení kontrol na pozadí se nepodařilo změnit.",
        ...
        "every_10_minutes": "Každých 10 minut",
        "every_15_minutes": "Každých 15 minut",
        "every_30_minutes": "Každých 30 minut",
        "every_45_minutes": "Každých 45 minut",
        ...
        "help_text": (
            ...
            "délce také posuvník, hlasitost 0 až 100 % a rychlost 0,5× až 2×. "
            "Přehrávání "
        ...
        "open_link_error": "Odkaz se nepodařilo otevřít ve výchozí aplikaci.",
        ...
        "recovery_failed": "Nastavení se nepodařilo zazálohovat a obnovit.",
    ...
    "en": {
        ...
        "feed_error_invalid_url": "The feed address is invalid.",
        "feed_error_network": "The feed could not be downloaded. Check the internet connection and try again.",
        "feed_error_http": "The server returned HTTP error {status}.",
        "feed_error_redirect": "The server returned an invalid or excessive redirect.",
        "feed_error_too_large": "The feed is larger than the allowed limit of {maximum} bytes.",
        "feed_error_invalid_xml": "The feed is not a valid XML document.",
        "feed_error_unsupported_format": "The document is not a supported RSS 2.0 or Atom 1.0 feed.",
        "feed_error_unknown": "An unknown error occurred.",
        "save_error": "The changes could not be stored safely. Existing data was preserved.",
        "store_unavailable": "The saved list cannot be read safely. Changes are disabled so the file is not overwritten.",
        ...
        "directory_error": "The directory could not be searched. {detail}",
        "directory_error_network": "The directory could not be downloaded. Check the internet connection and try again.",
        "directory_error_http": "The directory server returned HTTP error {status}.",
        "directory_error_redirect": "The directory server returned an invalid or unsafe redirect.",
        "directory_error_too_large": "The directory response is larger than the allowed limit of {maximum} bytes.",
        "directory_error_invalid_response": "The directory returned an invalid response.",
        "directory_error_unknown": "An unknown directory error occurred.",
        ...
        "opml_import_error": "The OPML file could not be imported. {detail}",
        "opml_export_error": "The OPML file could not be saved. {detail}",
        "opml_error_invalid_document": "The file is not a valid and safe OPML document.",
        "opml_error_file_access": "The selected file could not be accessed.",
        ...
        "guide_catalog_error": "The station list could not be loaded. Check the internet connection and try again.",
        ...
        "playback_error_detail": "This episode could not be played.",
        "speed_change_error": "The playback speed could not be changed.",
        "audio_session_denied": "Another application is currently using audio.",
        "play": "Play",
        "pause": "Pause",
        ...
        "language_change_error": "The application language could not be changed.",
        ...
        "background_checks_error": "The background-check setting could not be changed.",
        ...
        "every_45_minutes": "Every 45 minutes",
        ...
        "help_text": (
            ...
            "15 seconds back and 30 seconds forward, plus a timeline slider when "
            "the duration is known, volume from 0 to 100%, and speeds from 0.5× "
            "to 2×. Playback "
        ...
        "open_link_error": "The link could not be opened in the default application.",
        "status_ready": "Ready.",
        ...
        "recovery_failed": "The settings could not be backed up and restored.",
